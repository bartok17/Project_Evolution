Zasady i instrukcje kożystania z aplikacji:
...
wysokość i szerokość mapy: min 3, max 15,
wariant mapy: wbór z dostępnych
...
długość genomu zwierzaków: min 1
wariant zachowania zwierzaków : wbór z dostępnych.
